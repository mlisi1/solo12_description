...
def generate_launch_description():
    ...
    pkg_share = launch_ros.substitutions.FindPackageShare(package="anymal_c_simple_description").find("solo12_description")
    default_model_path = os.path.join(pkg_share, "urdf/solo12_floating_base.urdf")
